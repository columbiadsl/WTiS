...
# installed.
TK_PREFIX='/miniconda3/envs/TcpSocket'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/miniconda3/envs/TcpSocket'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/miniconda3/envs/TcpSocket/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/miniconda3/envs/TcpSocket/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/miniconda3/envs/TcpSocket/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/miniconda3/envs/TcpSocket/lib/libtkstub8.6.a'
