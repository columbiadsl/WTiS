...
# installed.
TCL_PREFIX='/miniconda3/envs/TcpSocket'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/miniconda3/envs/TcpSocket'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -I/miniconda3/envs/TcpSocket/include -fdebug-prefix-map=${SRC_DIR}=/usr/local/src/conda/${PKG_NAME}-${PKG_VERSION} -fdebug-prefix-map=${PREFIX}=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -mmacosx-version-min=10.9 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/miniconda3/envs/TcpSocket/lib -L/miniconda3/envs/TcpSocket/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/miniconda3/envs/TcpSocket/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/miniconda3/envs/TcpSocket/include'
...
TCL_PACKAGE_PATH='/miniconda3/envs/TcpSocket/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/miniconda3/envs/TcpSocket/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/miniconda3/envs/TcpSocket/lib/libtclstub8.6.a'
